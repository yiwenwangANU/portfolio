...
const PlayerYellow = ({ className }: Props) => {
  return (
    <svg
      className={className}
      width="54px"
      ...
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        >
          ...
          <circle
            ...
            r="27"
          ></circle>
          <circle fill="#FFCE67" cx="27" cy="27" r="24"></circle>
          <g
          ...
          >
            ...
            ></path>
            <g transform="translate(9.750000, 0.000000)">
              <line x1="0.5" y1="0" x2="0.5" y2="5.9844035"></line>
              <line x1="10.5" y1="0" x2="10.5" y2="5.9844035"></line>
            </g>
          </g>
        </g>
      </g>
